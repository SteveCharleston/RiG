...
public class TestMusicPlayer extends ActionBarActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test_music_player);
        ...
        getFragmentManager().beginTransaction()
                .add(R.id.test_musicplayer, songs).commit();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_test_music_player, menu);
        return true;
    }
